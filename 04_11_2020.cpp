...
class store
{
    public:
        ...
        void storepage()
        {
            ...
            gotoxy(78,4);cout<<">      CAN 101      <"<<endl;
            gotoxy(78,5);cout<<">-------------------<"<<endl<<endl;
            gotoxy(78,7);cout<<"| 1. VIEW INVENTORY |"<<endl;
            gotoxy(78,8);cout<<"| 2. ADD PRODUCT    |"<<endl;
            gotoxy(78,9);cout<<"| 3. SEARCH PRODUCT |"<<endl;
            gotoxy(78,10);cout<<"| 4. UPDATE PRODUCT |"<<endl;
            gotoxy(78,11);cout<<"| 5. DELETE PRODUCT |"<<endl;
            gotoxy(78,12);cout<<"| 6. BACK           |"<<endl;
            gotoxy(78,13);cout<<"| 7. EXIT           |"<<endl;
            gotoxy(78,14);cout<<"|___________________|"<<endl;
            gotoxy(5,16);cout<<"ENTER CHOICE :> ";cin>>choice;
            while(1)
                {
                    switch(choice)
                    {
                        case 1:
                            ...
                            gotoxy(78,7);cout<<"|    INVENTORIES    |"<<endl;
                            view_inventory();
                            storepage();
                            break;
                        case 2:
                            ...
                            gotoxy(78,4);cout<<">      CAN 101      <"<<endl;
                            gotoxy(78,5);cout<<">-------------------<"<<endl;
                            gotoxy(78,7);cout<<"|    ADD PRODUCT    |"<<endl;
                            add_dish();
                            storepage();
                            break;
                        case 3:
                        ...
                        case 4:
                            ...
                            gotoxy(78,4);cout<<">      CAN 101      <"<<endl;
                            gotoxy(78,5);cout<<">-------------------<"<<endl;
                            gotoxy(78,7);cout<<"|  UPDATE PRODUCT   |"<<endl;
                            update_dish();
                            storepage();
                            break;
                        case 5:
                            ...
                            gotoxy(78,4);cout<<">      CAN 101      <"<<endl;
                            gotoxy(78,5);cout<<">-------------------<"<<endl;
                            gotoxy(78,7);cout<<"| PRODUCT DELETION  |"<<endl;
                            delete_dish();
                            storepage();
                            break;
                        case 6:
            ...
            while(a!='N')
                {
                    ...
                    gotoxy(10,9);cout<<"ENTER THE PRODUCT KEY :> ";
                    cin>>k;
                     while(add>>dd.key>>dd.name>>dd.price>>dd.quantity)
                        {
                            if(dd.key==k)
                            {
                                cout<<"     KEY IS ALREADY EXITS"<<endl;
                                add.close();
                            goto top;
                            }
                        }
                    ...
                    dd.key=k;
                    cin.ignore();
                    gotoxy(10,11);cout<<"ENTER THE DISH NAME :> ";
                    gets(dd.name);
                    gotoxy(10,13);cout<<"ENTER THE DISH PRICE :> ";
                    cin>>dd.price;
                    gotoxy(10,15);cout<<"ENTER THE DISH QUANTITY :> ";
                    cin>>dd.quantity;
                    add<<dd.key<<' '<<dd.name<<' '<<dd.price<<' '<<dd.quantity<<endl;
                    gotoxy(10,17);cout<<"DO YOU WANT TO ADD ANOTHER PRODUCT [Y/N]:";
                    cin>>a;
                    add.close();
                }
        }
        void search_dish()
        {
            ...
            gotoxy(5,9);cout<<"ENTER THE PRODUCT KEY :> ";
            cin>>a;
            gotoxy(78,11);cout<<"PRODUCT DETAILS : "<<endl;
            while(searchkey>>dd.key>>dd.name>>dd.price>>dd.quantity)
            {
                if(dd.key==a)
                {
                    gotoxy(78,13);cout<<" ID        :    "<<dd.key;
                    gotoxy(78,14);cout<<" NAME      :    "<<dd.name;
                    gotoxy(78,15);cout<<" PRICE     :    "<<dd.price;
                    gotoxy(78,16);cout<<" QUANTITY  :    "<<dd.quantity;
                    c++;
                }
            }
            if(c==0)
        ...
        void update_dish()
        {
            ...
            ifstream tupdate("TEMP_DISH.txt");
            gotoxy(5,9);cout<<"ENTER THE PRODUCT KEY :> ";
            cin>>a;
            update.seekg(0);
            while(update>>dd.key>>dd.name>>dd.price>>dd.quantity)
            {
                if(dd.key==a)
                {
                    gotoxy(78,11);cout<<"DESTINATION RECORD :> "<<endl;
                    gotoxy(78,13);cout<<" ID        :    "<<dd.key;
                    gotoxy(78,14);cout<<" NAME      :    "<<dd.name;
                    gotoxy(78,15);cout<<" PRICE     :    "<<dd.price;
                    gotoxy(78,16);cout<<" QUANTITY  :    "<<dd.quantity;
                    KEY:
                        gotoxy(5,19);cout<<"ENTER NEW PRODUCT KEY:";cin>>dd.tkey;
                        cin.sync();
                        tupdate.seekg(0);
                        while(tupdate>>dd.key>>dd.name>>dd.price>>dd.quantity)
                        {
                            if(dd.tkey==dd.key)
                            {
                                gotoxy(5,20);cout<<"| >>  KEY EXIST  << |";
                                goto KEY;
                            }
                        }
                    gotoxy(5,20);cout<<"ENTER NEW PRODUCT NAME:";
                    gets(dd.name);
                    gotoxy(5,21);cout<<"ENTER NEW PRODUCT PRICE:";
                    cin>>dd.price;
                    gotoxy(5,22);cout<<"ENTER NEW PRODUCT QUANTITY:";
                    cin>>dd.quantity;
                    update1<<dd.tkey<<' '<<dd.name<<' '<<dd.price<<' '<<dd.quantity<<endl;
                    c++;
                }
                else
                {
        ...
        void delete_dish()
        {
            ...
            while(dlt>>dd.key>>dd.name>>dd.price>>dd.quantity)
            {
                if(dd.key==a)
                {
                    ...
                    gotoxy(78,15);cout<<" PRICE     :    "<<dd.price;
                    gotoxy(78,16);cout<<" QUANTITY  :    "<<dd.quantity;
                    gotoxy(78,18);cout<<"RECORD DELETED"<<endl;
                }
                if(dd.key!=a)
                {
...
class customer
{
    public:
        ...
        void customerpage()
        {
            ...
            gotoxy(78,4);cout<<">      CAN 101      <"<<endl;
            gotoxy(78,5);cout<<">-------------------<"<<endl<<endl;
            gotoxy(72,7);cout<<"| 1. VIEW INVENTORY & TAKE ORDER |"<<endl;
            gotoxy(72,8);cout<<"| 2. BACK                        |"<<endl;
            gotoxy(72,9);cout<<"| 3. EXIT                        |"<<endl;
            gotoxy(72,10);cout<<"|________________________________|"<<endl;
            gotoxy(5,12);cout<<"ENTER CHOICE :> ";cin>>choice;
            while(1)
                {
                    switch(choice)
                    {
                        case 1:
                            ...
                            gotoxy(78,4);cout<<">      CAN 101      <"<<endl;
                            gotoxy(78,5);cout<<">-------------------<"<<endl;
                            gotoxy(78,7);cout<<"|     ORDERING      |"<<endl;
                            take_order();
                            customerpage();
                            break;
                        case 2:
        ...
        void take_order()
        {
            ...
            if(empty_list==1)
            {
                ...
                while(ch!='N')
                    {
                        ...
                        while(o>>dd.key>>dd.name>>dd.price>>dd.quantity)
                        {
                            if(dd.key==a)
                            {
                                ...
                                if(dd.quantity>=tp.qty)
                                {
                                    ...
                                    cout<<"          PRICE     :    "<<dd.price<<endl;
                                    cout<<"          QUANTITY  :    "<<tp.qty<<endl;
                                    cout<<"          ----------------------------\n";
                                    cout<<"          AMOUNT    :    "<<tp.amount<<endl;
                                    strcpy(tp.d,dd.name);
                                    tp.p=dd.price;
                        ...
                        cout<<"\n     DO YOU WANT TO OERDER MORE[Y/N]";
                        cin>>ch;
                        o.close();
                        on.close();
                        remove("DISH.txt");
                ...
                gotoxy(78,4);cout<<">      CAN 101      <"<<endl;
                gotoxy(78,5);cout<<">-------------------<"<<endl;
                gotoxy(78,7);cout<<"|      BILLING      |"<<endl;
                gotoxy(37,9);cout<<"||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||";
                gotoxy(37,10);cout<<"|||||||||||||||||||||||||||||||||||||||||||||||  BILL  |||||||||||||||||||||||||||||||||||||||||||||||||||||||";
                gotoxy(37,11);cout<<"||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||";
                showbill();
                cout<<"\n\t\t\t\t     ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||"<<endl;
        ...
        void showbill()
        {
            ...
            cout<<"\n\t\t\t\t      HELLO "<<cname<<endl;
            cout<<"\n\t\t\t\t\t\t\t       ||| DISH NAME         | PRICE  | QUANTITY | AMOUNT   |||"<<endl;
            cout<<"\t\t\t\t\t\t\t       --------------------------------------------------------"<<endl;
            while(obj>>tp.d>>tp.p>>tp.qty>>tp.amount)
            {
                    cout<<"\t\t\t\t\t\t\t       ||| "<<setw(17)<<std::left<<tp.d<<" | "<<setw(6)<<std::left<<tp.p<<" | "<<setw(8)<<std::left<<tp.qty<<" | "<<setw(8)<<std::left<<tp.amount<<" |||"<<endl ;
            }
            obj.close();
        }
};
            ...
            while(edit>>id>>sname>>fname>>age>>salary>>phn>>email)
            {
                if(strcmp(tid,id)==0)
                {
                    ...
                    ID:
                        ...
                        cin.sync();
                        tedit.seekg(0);
                        while(tedit>>id>>sname>>fname>>age>>salary>>phn>>email)
                        {
                            if(strcmp(nid,id)==0)
                            {
                                gotoxy(5,22);cout<<"| >>  ID EXIST  << |";
                                goto ID;
                            }
                        }
  ...
  public:
      ...
      void loginpage()
      {
        ...
        void employeemenu()
        {
            ...
            gotoxy(78,5);cout<<">-------------------<"<<endl<<endl;
            gotoxy(78,7);cout<<"| 1. VIEW INVENTORY |"<<endl;
            gotoxy(78,8);cout<<"| 2. ADD DISH       |"<<endl;
            gotoxy(78,9);cout<<"| 3. SEARCH DISH    |"<<endl;
            gotoxy(78,10);cout<<"| 4. UPDATE DISH    |"<<endl;
            gotoxy(78,11);cout<<"| 5. DELETE DISH    |"<<endl;
            gotoxy(78,12);cout<<"| 6. BACK           |"<<endl;
            gotoxy(78,13);cout<<"| 7. EXIT           |"<<endl;
            gotoxy(78,14);cout<<"|___________________|"<<endl;
            gotoxy(5,16);cout<<"ENTER CHOICE :> ";cin>>choice;
