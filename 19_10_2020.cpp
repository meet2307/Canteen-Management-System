        ...
        void update_dish()
        {
            ...
            while(update>>dd.key>>dd.name>>dd.price>>dd.quantity)
            {
                if(dd.key==a)
                {
                    ...
                    gotoxy(78,15);cout<<" PRICE     :    "<<dd.price;
                    gotoxy(78,16);cout<<" QUANTITY  :    "<<dd.quantity;
                    gotoxy(5,19);cout<<"ENTER NEW PRODUCT KEY:";
                    cin>>dd.key;
                    cin.ignore();
                    gotoxy(5,21);cout<<"ENTER NEW PRODUCT NAME:";
                    gets(dd.name);
                    gotoxy(5,23);cout<<"ENTER NEW PRODUCT PRICE:";
                    cin>>dd.price;
                    gotoxy(5,25);cout<<"ENTER NEW PRODUCT QUANTITY:";
                    cin>>dd.quantity;
